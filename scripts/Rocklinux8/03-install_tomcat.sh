...
echo "Installing selinux package list..."
sudo dnf install -y wget policycoreutils-python-utils
...
semanage fcontext -a -t bin_t "$TOMCAT_HOME/bin(/.*)?"
restorecon -Rv $TOMCAT_HOME/bin
...
echo "opening the tomcat port 8080/"
